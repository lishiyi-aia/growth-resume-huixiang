...
year: 2026
role: 个人独立研究 / 海外增长运营 / 用户研究 / 竞品分析
tags: [海外增长, 潮玩交易, 社媒运营, KOL/KOC, 用户裂变]
link: projects/overseas-toy-growth-project-v2/portfolio_case_study.html
---

## 项目背景

这是一个个人独立增长研究项目。项目以海外 C2C 潮玩二手交易 App 为研究对象，通过公开财报、监管信息、平台规则和社区观察，分析用户从“想买”到“敢买”之间的决策阻力，并形成用户分层、竞品定位、信任机制、社媒增长、达人合作、活动裂变与跨团队落地方案。
...
**活动与裂变**：设计“邀请收藏搭子”路径，将邀请落地页、认证资料完成、首次收藏/发布和首笔受保护交易连接起来，并用双边奖励、设备去重和退款回收规则控制低质量增长。

**跨团队落地**：把增长方案拆给产品、设计、客服与信任安全、卖家运营及物流协作方，明确页面、内容、SOP、履约标准和异常反馈的交付关系。
...
- 活动方案：四周社媒启动节奏、达人预算分配与用户裂变路径。
- 协作地图：产品、设计、客服、信任安全、卖家运营与物流交付清单。
- 指标体系：North Star、AARRR、RICE 实验优先级与增长护栏。

## 项目总结

这个项目最终形成一套 trust-led growth 研究框架：以可追溯证据识别用户从种草到交易之间的信任阻碍，再把用户路径、产品机制、社媒运营、达人合作、活动裂变、跨团队交付和指标设计连接成完整闭环。
